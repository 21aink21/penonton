...
- 🎯 **Dukungan Movie & Series Terpadu**:
  - Scraping katalog Film bioskop dari `tv12.lk21official.cc`.
  - Scraping serial drama, drakor, anime, dan serial barat dari `tv9.nontondrama.my`.
  - REST API pencarian instan terpusat via `gudangvape.com`.
